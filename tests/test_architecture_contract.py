...
def test_frozen_architecture_contract_is_valid() -> None:
    ...
    for document in (
        ...
        "PRODUCT-ROUTING.md",
        "SPATIAL-REFERENCE.md",
        "CLOCK-AUTHORITY.md",
        "STORAGE-PARTITIONING.md",
        "MIGRATION.md",
        "ADR-001-sports-semantic-overlay.md",
        "ADR-002-source-catalog.md",
        "ADR-003-parquet-no-table-format.md",
        "ADR-004-cross-sport-event-envelope.md",
