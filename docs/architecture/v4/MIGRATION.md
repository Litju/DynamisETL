...
2. Additive PostgreSQL tables represent the semantic overlay, source catalog, provider crosswalk and spatial/clock authority. Grain metadata on existing artifact rows is nullable for preserved legacy records.
