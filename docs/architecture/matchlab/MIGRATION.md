...
The WebGPU comparison also completed all twelve Field, Pose and split runs without renderer or console errors. In this workstation sample, WebGPU Field/Pose measured 42/50 FPS at 1600×1000 and 41/52 FPS at 1440×900, while WebGL2 measured 58/57 and 59/57 FPS. WebGPU split measured 7 FPS at both sizes, versus WebGL2 at 49/42 FPS, with p95 frame intervals of 300/233.4 ms on WebGPU and 33.4/50 ms on WebGL2. Keep WebGL2 as the production backend.
